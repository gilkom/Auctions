...
public class AuctionsApplication {
	...
	public static void main(String[] args) {
		...
		AuctionItem rower = new AuctionItem("Super rower costam", 1, 40.00, 50.00, 2.00, 40.00);
		AuctionItem rower1 = new AuctionItem("Super rower1 costam", 1, 40.00, 50.00, 2.00, 40.00);
		AuctionItem rower2 = new AuctionItem("Super rower2 costam", 1, 40.00, 50.00, 2.00, 40.00);
